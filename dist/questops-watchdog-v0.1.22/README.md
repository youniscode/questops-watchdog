...
> **Current version:** v0.1.22 — [View Changelog](CHANGELOG.md)
...
```powershell
# Package with a specific version (auto-detects "v" prefix)
powershell -File scripts\package_release.ps1 -Version "v0.1.22"

# Package without specifying version (reads from VERSION file)
...
| Item | Source |
|------|--------|
| `README.md`, `CHANGELOG.md`, `VERSION`, `PROJECTMAP.md`, `AI_WORKSPACE_RULES.md` | Project root |
